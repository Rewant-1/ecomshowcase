      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              {/* Logo */}
              <Link to="/" className="inline-block" aria-label="Stellar Precision">
                <span className="text-lg font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-emerald-400">Stellar Precision</span>
              </Link>
            </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2">Categories</h6>
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="/categories/telescopes" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Telescopes</Link>
              </li>
              <li className="mb-2">
                <Link to="/categories/compasses" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Compasses</Link>
              </li>
              <li className="mb-2">
                <Link to="/categories/sundials" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Sundials</Link>
              </li>
              <li className="mb-2">
                <Link to="/categories/table-clocks" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Table Clocks</Link>
              </li>
              <li className="mb-2">
                <Link to="/categories/binoculars" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Binoculars</Link>
              </li> 
              <li className="mb-2">
                <Link to="/categories/walking-sticks" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Walking Sticks</Link>
              </li>                            
            </ul>
          </div>
